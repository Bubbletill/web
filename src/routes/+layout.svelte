...
<footer class="gweb-footer footer-sticky">
    <div class="content footer-text has-text-centered">
        <div class="gweb-text-layout">
            <p style="font-size: 15px;"><b>© Bubbletill 2024</b></p>
            <p style="font-size: 15px;" class="gweb-link-white">
                <a href="https://github.com/bubbletill/web" target="_blank" rel="noopener">source</a> &middot;
                <a href="https://github.com/bubbletill/" target="_blank" rel="noopener">github</a>
            </p>
        </div>
